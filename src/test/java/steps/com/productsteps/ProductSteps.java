...
public class ProductSteps {
    ...
    @When("the user enters product info {string} and {string}")
    public void the_user_enters_product_info_and(String productName, String quantity) {
    ...
    @Then("the user validate product detail {string},{string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}")
    public void the_user_validate_product_detail(String productName, String quantity, String name, String street, String city, String state, String zipcode, String cardType, String cardNumber, String expireDate) {
       orderPage.clickAllOrder();
